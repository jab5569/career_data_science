...
**Problem:** Manual campaign bidding was extremely inefficient from both cost and process perspectives

**Solution:** My team and I created a AI-based tool named the COE or the Campaign Optimization Engine (COE) which auto-bids the most appropriate bid amount for n-number of ad campaigns.
